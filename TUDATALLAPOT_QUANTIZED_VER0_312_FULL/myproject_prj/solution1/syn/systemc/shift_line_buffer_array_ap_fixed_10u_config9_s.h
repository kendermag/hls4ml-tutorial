...
#ifndef _shift_line_buffer_array_ap_fixed_10u_config9_s_HH_
#define _shift_line_buffer_array_ap_fixed_10u_config9_s_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "shift_line_buffer_array_ap_fixed_10u_config9_s_line_buffeBew.h"

namespace ap_rtl {

struct shift_line_buffer_array_ap_fixed_10u_config9_s : public sc_module {
    ...
    sc_in< sc_lv<6> > kernel_window_32_V_write;
    sc_in< sc_lv<6> > kernel_window_33_V_write;
    sc_in< sc_lv<6> > kernel_window_34_V_write;
    sc_in< sc_lv<6> > kernel_window_35_V_write;
    sc_in< sc_lv<6> > kernel_window_36_V_write;
    sc_in< sc_lv<6> > kernel_window_37_V_write;
    sc_in< sc_lv<6> > kernel_window_38_V_write;
    sc_in< sc_lv<6> > kernel_window_39_V_write;
    ...
    // Module declarations
    shift_line_buffer_array_ap_fixed_10u_config9_s(sc_module_name name);
    SC_HAS_PROCESS(shift_line_buffer_array_ap_fixed_10u_config9_s);

    ~shift_line_buffer_array_ap_fixed_10u_config9_s();

    sc_trace_file* mVcdFile;

    shift_line_buffer_array_ap_fixed_10u_config9_s_line_buffeBew* line_buffer_Array_V_4_0_0_U;
    shift_line_buffer_array_ap_fixed_10u_config9_s_line_buffeBew* line_buffer_Array_V_4_0_1_U;
    shift_line_buffer_array_ap_fixed_10u_config9_s_line_buffeBew* line_buffer_Array_V_4_0_2_U;
    shift_line_buffer_array_ap_fixed_10u_config9_s_line_buffeBew* line_buffer_Array_V_4_0_3_U;
    shift_line_buffer_array_ap_fixed_10u_config9_s_line_buffeBew* line_buffer_Array_V_4_0_4_U;
    shift_line_buffer_array_ap_fixed_10u_config9_s_line_buffeBew* line_buffer_Array_V_4_0_5_U;
    shift_line_buffer_array_ap_fixed_10u_config9_s_line_buffeBew* line_buffer_Array_V_4_0_6_U;
    shift_line_buffer_array_ap_fixed_10u_config9_s_line_buffeBew* line_buffer_Array_V_4_0_7_U;
    shift_line_buffer_array_ap_fixed_10u_config9_s_line_buffeBew* line_buffer_Array_V_4_0_8_U;
    shift_line_buffer_array_ap_fixed_10u_config9_s_line_buffeBew* line_buffer_Array_V_4_0_9_U;
