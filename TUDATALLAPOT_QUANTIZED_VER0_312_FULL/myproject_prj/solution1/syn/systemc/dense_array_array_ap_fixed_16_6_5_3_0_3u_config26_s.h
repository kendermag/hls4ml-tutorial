...
#ifndef _dense_array_array_ap_fixed_16_6_5_3_0_3u_config26_s_HH_
#define _dense_array_array_ap_fixed_16_6_5_3_0_3u_config26_s_HH_
...
struct dense_array_array_ap_fixed_16_6_5_3_0_3u_config26_s : public sc_module {
    ...
    // Module declarations
    dense_array_array_ap_fixed_16_6_5_3_0_3u_config26_s(sc_module_name name);
    SC_HAS_PROCESS(dense_array_array_ap_fixed_16_6_5_3_0_3u_config26_s);
    ...
    sc_signal< sc_lv<6> > data_0_V_reg_230;
    sc_signal< sc_logic > io_acc_block_signal_op3;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<6> > data_1_V_reg_235;
    sc_signal< sc_lv<6> > data_2_V_reg_240;
    sc_signal< sc_lv<6> > data_3_V_reg_245;
    sc_signal< sc_lv<6> > data_4_V_reg_250;
    sc_signal< sc_lv<6> > data_5_V_reg_255;
    sc_signal< sc_lv<6> > data_6_V_reg_260;
    sc_signal< sc_lv<6> > data_7_V_reg_265;
    sc_signal< sc_lv<6> > data_8_V_reg_270;
    sc_signal< sc_lv<6> > data_9_V_reg_275;
    sc_signal< sc_lv<6> > data_10_V_reg_280;
    sc_signal< sc_lv<6> > data_11_V_reg_285;
    sc_signal< sc_lv<6> > data_12_V_reg_290;
    sc_signal< sc_lv<6> > data_13_V_reg_295;
    sc_signal< sc_lv<6> > data_14_V_reg_300;
    sc_signal< sc_lv<6> > data_15_V_reg_305;
    sc_signal< sc_logic > grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_start;
    sc_signal< sc_logic > grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_done;
    sc_signal< sc_logic > grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_idle;
    sc_signal< sc_logic > grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_ready;
    sc_signal< sc_lv<16> > grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_return_0;
    sc_signal< sc_lv<16> > grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_return_1;
    sc_signal< sc_lv<16> > grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_return_2;
    sc_signal< sc_logic > grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_start_reg;
    sc_signal< bool > ap_block_state1_ignore_call37;
    ...
    void thread_ap_block_state1_ignore_call37();
    void thread_ap_done();
    void thread_ap_idle();
    ...
    void thread_grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_start();
