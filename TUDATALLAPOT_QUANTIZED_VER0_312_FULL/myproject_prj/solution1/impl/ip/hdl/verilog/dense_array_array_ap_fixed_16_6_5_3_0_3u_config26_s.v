...
module dense_array_array_ap_fixed_16_6_5_3_0_3u_config26_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg   [5:0] data_0_V_reg_230;
wire    io_acc_block_signal_op3;
reg    ap_block_state1;
reg   [5:0] data_1_V_reg_235;
reg   [5:0] data_2_V_reg_240;
reg   [5:0] data_3_V_reg_245;
reg   [5:0] data_4_V_reg_250;
reg   [5:0] data_5_V_reg_255;
reg   [5:0] data_6_V_reg_260;
reg   [5:0] data_7_V_reg_265;
reg   [5:0] data_8_V_reg_270;
reg   [5:0] data_9_V_reg_275;
reg   [5:0] data_10_V_reg_280;
reg   [5:0] data_11_V_reg_285;
reg   [5:0] data_12_V_reg_290;
reg   [5:0] data_13_V_reg_295;
reg   [5:0] data_14_V_reg_300;
reg   [5:0] data_15_V_reg_305;
wire    grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_start;
wire    grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_done;
wire    grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_idle;
wire    grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_ready;
wire   [15:0] grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_return_0;
wire   [15:0] grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_return_1;
wire   [15:0] grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_return_2;
reg    grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_start_reg;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 2'd1;
#0 grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_start_reg = 1'b0;
end

dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((io_acc_block_signal_op46 == 1'b0) | (grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_done == 1'b0)) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_start_reg <= 1'b0;
    end else begin
        if ((~((real_start == 1'b0) | (io_acc_block_signal_op3 == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_start_reg <= 1'b1;
        end else if ((grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_ready == 1'b1)) begin
            grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if ((~((io_acc_block_signal_op46 == 1'b0) | (grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_done == 1'b0)) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1_ignore_call37 = ((real_start == 1'b0) | (io_acc_block_signal_op3 == 1'b0) | (ap_done_reg == 1'b1));
end

assign ap_ready = internal_ap_ready;

assign grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_start = grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_start_reg;
...
assign io_acc_block_signal_op46 = (res_stream_V_data_2_V_full_n & res_stream_V_data_1_V_full_n & res_stream_V_data_0_V_full_n);

assign res_stream_V_data_0_V_din = grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_return_0;

assign res_stream_V_data_1_V_din = grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_return_1;

assign res_stream_V_data_2_V_din = grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config26_s_fu_113_ap_return_2;

assign start_out = real_start;

endmodule //dense_array_array_ap_fixed_16_6_5_3_0_3u_config26_s
