...
module Block_myproject_axi_exit38_proc715 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [15:0] tmp_data_V_74_12_reg_54;
wire    io_acc_block_signal_op4;
reg    ap_block_state1;
reg   [15:0] tmp_data_V_74_23_reg_59;
reg   [2:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (io_acc_block_signal_op4 == 1'b0) | (tmp_data_V_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    ...
    end else if ((~((ap_start == 1'b0) | (io_acc_block_signal_op4 == 1'b0) | (tmp_data_V_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((((tmp_data_V_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state3)) | ((tmp_data_V_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state2)) | (~((ap_start == 1'b0) | (io_acc_block_signal_op4 == 1'b0) | (tmp_data_V_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)))) begin
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (io_acc_block_signal_op4 == 1'b0) | (tmp_data_V_full_n == 1'b0) | (ap_done_reg == 1'b1));
end

assign io_acc_block_signal_op4 = (out_local_V_data_2_V_empty_n & out_local_V_data_1_V_empty_n & out_local_V_data_0_V_empty_n);

endmodule //Block_myproject_axi_exit38_proc715
