...
entity softmax_latency_array_array_softmax_config28_s_exp_table4_rom is 
    generic(
             DWIDTH     : integer := 17; 
             AWIDTH     : integer := 10; 
...
architecture rtl of softmax_latency_array_array_softmax_config28_s_exp_table4_rom is 
...
entity softmax_latency_array_array_softmax_config28_s_exp_table4 is
    generic (
...
architecture arch of softmax_latency_array_array_softmax_config28_s_exp_table4 is
    component softmax_latency_array_array_softmax_config28_s_exp_table4_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    softmax_latency_array_array_softmax_config28_s_exp_table4_rom_U :  component softmax_latency_array_array_softmax_config28_s_exp_table4_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
