...
set ID 318
set hasByteEnable 0
set MemName shift_line_buffer_array_ap_fixed_10u_config10_s_line_buffLf8
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_80_V_write { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_81_V_write { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_82_V_write { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_83_V_write { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_84_V_write { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_85_V_write { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_86_V_write { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_87_V_write { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_88_V_write { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_89_V_write { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_54_V_read { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_55_V_read { I 16 vector } } \
} "
}
